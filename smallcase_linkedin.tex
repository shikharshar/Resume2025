...
\cvtag{User Journey Mapping}
\cvtag{Conversion Funnel Optimization}
\cvtag{Analytics}
\cvtag{Feature Adoption}
...
\cvtagline{B2C Product Marketing and Growth | Driving User Journeys and Feature Adoption in Fintech}
...
\item Executed multi-channel marketing campaigns, analyzing user funnels to boost lead conversion by 50% MoM.
\item Led WhatsApp marketing campaigns and data analysis, driving user engagement and presenting key insights to stakeholders.
...
\begin{itemize}
\item Automated user communication via email and WhatsApp, improving response rates by 87% and driving user action.
