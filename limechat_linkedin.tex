...
\cvtagline{Product Manager with a Founder's Mindset \& Technical Acumen}
...
\begin{itemize}
\item Drafted product briefs for scraping tools; managed the dev lifecycle \& coordinated with tech and design teams.
...
\item Liaised with 250+ D2C merchants, gathering requirements and feedback for product adjustments post-RBI changes.
