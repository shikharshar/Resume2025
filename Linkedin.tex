...
\cvtagline{Data-Driven Program Manager | Enhancing Customer Experience \& Process Improvement}
...
\begin{itemize}
\item Used data \& metrics to define \& implement process improvements, increasing conversion rates by 50\% MoM.
...
\item Drove complex data projects with tech teams, defining requirements and overseeing the end-to-end delivery.
...
\begin{itemize}
\item Drove process improvements by automating key workflows; used data and metrics to reduce manual effort by 95\%.
