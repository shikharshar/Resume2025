...
\cvtag{User Retention and Engagement}
\cvtag{Customer Lifecycle Growth}
\cvtag{Monetization Strategy}
\cvtag{Negotiation}
\cvtag{LTV Analysis}
...
\cvtagline{Growth Leader | Driving User Retention, Monetization and Data-Driven Experimentation}
...
\item Drove 50\% MoM conversion increase by executing data-driven retention and engagement experiments
...
\item Analyzed marketing data to drive strategy, presenting key insights to product and tech teams
...
\begin{itemize}
\item Reduced manual effort by 95\% by designing and implementing scalable growth automation workflows
