...
\cvtag{User Onboarding Flows}\\
\cvtag{Stakeholder Management}
\cvtag{B2B2C Product Strategy}\\
\cvtag{Negotiation}
...
\cvtagline{Fintech Product Manager | Building \& Scaling User-Centric Financial Products}
...
\item Improved lead conversion funnel by \textbf{50\% MoM} by implementing new product-led growth strategies.
...
\item Defined product requirements \& led tech team to build a data product extracting \textbf{10M+} business accounts.
...
\begin{itemize}
\item Improved the merchant acquisition funnel via automation, boosting reply rate to \textbf{45\%} and demo conversion to \textbf{25\%}.
