...
\cvtagline{Product Manager | Fintech & B2B2C | Ex-Founder}
...
\begin{itemize}
\item Owned product-led growth funnels, driving 5.5K+ monthly user acquisitions via data-driven marketing strategies.
...
\begin{itemize}
\item Improved merchant onboarding funnel, boosting demo conversions by 25% and reducing manual GTM efforts by 95% via automation.
