% Single file resume - includes all components
\PassOptionsToPackage{dvipsnames}{xcolor}

\documentclass[10pt,a4paper]{article}

% Class definitions from altacv.cls integrated here
...
% Command definitions from altacv.cls
...
\cvachievement{\faTrophy}{2022}{Secured \textbf{99.53 Percentile} in Indian Institute of Management Common Admission Test}

\divider

\cvachievement{\faTrophy}{2021}{Secured \textbf{1st prize} in the Inter IIT Art Competition on the theme of Emotion}

\divider

\cvachievement{\faTrophy}{2018}{Secured \textbf{All India Rank 4719} in Joint Entrance Exam (JEE) - Advanced among the 0.16 million candidates }

\divider

\cvachievement{\faTrophy}{2018}{Secured \textbf{All India Rank 7733} in Joint Entrance Exam (JEE) - Mains among the 1 million candidates }
...
\cvtagline{Technical Programme Manager | Data-Driven Growth & Analytics Program Delivery}
...
\personalinfo{%
  ...
  \faGlobe \, {\href{https://pleasant-fifth-cc3.notion.site/Shikhar-Sharma-Backend-Developer-8f5b5fa02dc94425a97e6fefac0bea9a}{\textcolor{SlateGrey}{website}}}
}
...
\begin{itemize}
\item  Managed a INR 5M program, coordinating tech & design to meet KPIs & reporting progress to stakeholders.
...
\begin{itemize}
\item Drove a tech automation program improving efficiency by 95% & stakeholder conversions by 25% through strategic coordination.
