...
\cvtagline{Growth and Program Manager | Scaling User Acquisition through Rapid Experimentation}
...
\item Drove a \textbf{50\% MoM} conversion uplift by running growth experiments and optimizing user acquisition funnels.
...
\item Launched a new acquisition channel by processing \textbf{6.4M} products, generating \textbf{30K+} leads for the sales funnel.
...
\item Owned a critical program to retain \textbf{250+ merchants} in a high-speed, ambiguous post-RBI shutdown environment.
