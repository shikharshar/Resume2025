...
\cvtagline{Growth Program Manager | Scaling Acquisition via Rapid Experimentation & Data Analytics}
...
\begin{itemize}
\item Scaled Meta Ads as a key acquisition channel, optimizing the funnel to generate \textbf{5,500+} quality leads per month.
...
\item Scaled a new acquisition channel via WhatsApp data, identifying \textbf{10M} potential business accounts and guiding tech implementation.
...
\begin{itemize}
\item Ran outreach automation experiment, optimizing funnels to a \textbf{25\%} demo conversion rate; scaled to reduce manual effort by \textbf{95\%}.
