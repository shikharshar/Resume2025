...
\cvtag{User Experience (UX)}
\cvtag{SaaS Platforms}
...
\cvtagline{Product Manager | Building User-Centric SaaS Platforms and Driving Growth}
...
\item Owned a data platform that scraped 6.4M products, enabling lead generation and listing management for 30k+ sellers.
\item  Led product strategy and tech execution for a tool to acquire 10M business accounts, driving platform user growth.
...
\item Developed an automated agreement generation module, boosting response rates and streamlining contract workflows.
\end{itemize}
