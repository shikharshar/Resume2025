...
\cvtag{User Retention Strategies}
\cvtag{Product Personalization}
\cvtag{Customer Lifecycle Marketing}
\cvtag{Negotiation}
\cvtag{CRM Strategy}
...
\cvtagline{Product Manager | Customer Retention, Growth, and Personalization}
...
\item Improved repeat purchase rate by launching personalized campaigns based on user segmentation and lifecycle stage.
...
\item Drove user retention by A/B testing personalized user journeys, optimizing KPIs and campaign performance across marketing channels
...
\begin{itemize}
\item Owned lifecycle marketing via automated email/WhatsApp campaigns, improving user re-engagement and streamlining execution with CRM tools.
