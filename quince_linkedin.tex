...
\cvtag{Retention Marketing}
\cvtag{Lifecycle Marketing}
\cvtag{Customer Segmentation}
\cvtag{CRM Tools}
\cvtag{Personalization}
...
\cvtagline{Product Manager | Driving Customer Retention and Growth in D2C eCommerce}
...
\item Enhanced user conversion by 50\% MoM via personalized journeys and iterative A/B testing of content.
\item Built dashboards to monitor retention KPIs, analyzing user data to optimize lifecycle marketing strategies.
...
\item Led high-engagement email and WhatsApp campaigns for 250+ merchants, achieving an 87\% response rate.
\end{itemize}
