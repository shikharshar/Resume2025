...
\cvtag{User Retention Strategy}
\cvtag{User Engagement}
\cvtag{Product Roadmap Management}
\cvtag{Gamification}
...
\cvtagline{B2C Product Manager Driving User Growth, Retention, and Engagement}
...
\item Analyzed user journeys to implement new strategies, achieving a 50% MoM increase in user conversion.
...
\begin{itemize}
\item Launched automated user campaigns, hitting a 45% reply rate and 25% conversion, cutting manual effort by 95%.
\item Drove user retention strategy during a critical service pivot, successfully retaining key merchant accounts.
