...
\cvtagline{Fintech Product Manager | Ex-Founder | Driving Execution in Lending and Payments}
...
\item Analyzed user conversion funnels and shipped product enhancements, resulting in a 50% MoM conversion uplift.
...
\item Defined product requirements for a data extraction tool, collaborating with the tech team to guide implementation and delivery.
...
\begin{itemize}
\item Owned GTM feature automation, reducing manual sales effort by 95% and achieving a 45% reply rate for user outreach.
