...
\cvtagline{Program Manager driving Operational Excellence and Process Improvement in E-commerce}
...
\begin{itemize}
\item Managed a INR 5M budget, tracking KPIs via dashboards to optimize processes and drive strategic business decisions
...
\begin{itemize}
\item Engineered an automated outreach process, reducing manual effort by 95\% and optimizing merchant communication workflows
