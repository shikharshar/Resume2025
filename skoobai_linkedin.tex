...
\cvtag{Product Roadmapping}
\cvtag{User Engagement Strategy}
\cvtag{User Feedback Analysis}
\cvtag{JIRA/Trello}
...
\cvtagline{Product Manager | B2C Apps and User Growth | Ex-Founder}
...
\item Analyzed 6.4M product data points to identify market trends and inform product strategy for B2C user acquisition.
\item Led product strategy and guided the tech team to build a data pipeline, unlocking insights from 10M accounts for growth.
...
\begin{itemize}
\item Drove user acquisition experiments via automated campaigns, increasing conversion by 25\% while reducing manual effort by 95\%.
