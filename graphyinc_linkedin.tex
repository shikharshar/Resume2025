...
\cvtag{Product Analytics}
\cvtag{Creator Economy}
\cvtag{Negotiation}
\cvtag{Data Privacy}
...
\cvtagline{Product Manager with SaaS and D2C Growth Experience}
...
\item Drove a \textbf{50\% MoM} conversion uplift by iterating on marketing strategies based on performance data analysis.
...
\item Defined product strategy for a data scraping engine; partnered with engineering to extract \textbf{10M+} business accounts for lead gen.
...
\begin{itemize}
\item Owned development of a growth product, boosting demo conversions by \textbf{25\%} and cutting manual efforts by \textbf{95\%}.
