...
\cvtagline{Ex-Founder and Generalist with experience in SaaS, Product, and Growth}
...
\begin{itemize}
\item Drove growth via Meta campaigns with an INR 5M budget, generating 5,500+ leads monthly for the sales funnel.
...
\item Led strategy for a growth automation project, acquiring 10M business accounts while guiding tech team implementation.
...
\item Led customer ops during a crisis, retaining 250+ key merchants by successfully renegotiating partnership terms.
