...
\cvtagline{AI-Powered Growth Hacker | Building Distribution and Automation from 0 to 1}
...
\begin{itemize}
\item Ran data-driven experiments across channels, automating lead capture and boosting MoM lead conversion by 50\%.
...
\item Automated multi-channel campaigns (Email/WhatsApp) to 250+ merchants, achieving an 87\% response rate for critical updates.
