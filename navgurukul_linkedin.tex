...
\cvtag{User Research \& Feedback}
\cvtag{Stakeholder Management}
\cvtag{Product Requirement Docs (PRDs)}
\cvtag{Adaptability}
...
\cvtagline{Product Manager with an Entrepreneurial Mindset | Ex-Founder Driving Impactful Solutions}
...
\item Drove product strategy for a data engine, processing 6.4M products to identify high-value seller personas for platform growth
...
\begin{itemize}
\item Identified operational bottlenecks \& developed an automated outreach product, boosting team efficiency and increasing user engagement by 45\%
