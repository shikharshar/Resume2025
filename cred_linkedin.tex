...
\cvtag{Consumer Product Growth}
\cvtag{User Acquisition}
...
\cvtagline{Consumer Fintech Growth Leader | Driving User Acquisition and Engagement in Cards and Lending}
...
\item Drove \textbf{50\% MoM} growth in user conversion by designing and running rapid, data-driven marketing experiments
...
\item Engineered data pipelines for 6.4M products, identifying high-value segments to drive consumer-focused growth
...
\begin{itemize}
\item Drove user engagement campaigns with automation, achieving a \textbf{45\%} reply rate and optimizing the conversion funnel
