...
\cvtag{Product Specification}
\cvtag{Product Prioritization}
\cvtag{B2B SaaS}
\cvtag{Product Metrics}
...
\cvtagline{Product Manager | Ex-Founder driving growth in SaaS & D2C}
...
\item Drove 50\% MoM lead conversion uplift by analyzing user data \& iterating on marketing-product features.
...
\item Retained 250+ D2C merchants by understanding needs \& aligning product value post-RBI changes.
