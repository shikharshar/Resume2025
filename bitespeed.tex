...
\cvtag{User Interviews}
\cvtag{PRD Specification}
\cvtag{Competitive Analysis}
\cvtag{Negotiation}
\cvtag{User Empathy}
...
\cvtagline{Product Manager | Ex-Founder with D2C & SaaS Product Experience}
...
\item Drove 50\% MoM lead conversion boost via data-driven experimentation and strategic funnel optimizations.
...
\begin{itemize}
\item Built an automated outreach system to gather market feedback, achieving a 45\% reply rate for product insights.
