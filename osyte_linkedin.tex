...
\cvtagline{Fintech Product Manager Driving User-Centric Solutions}
...
\item Drove a 50\% MoM conversion lift by defining metrics and iterating on user acquisition strategies.
...
\begin{itemize}
\item Translated sales needs into an automation tool, boosting demo conversions by 25\% and cutting manual effort by 95\%.
