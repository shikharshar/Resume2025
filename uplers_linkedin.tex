...
\cvtag{B2B SaaS}
\cvtag{Product Lifecycle Mgt}
\cvtag{Negotiation}
\cvtag{Backlog Mgmt}
\cvtag{Stakeholder Mgt}
\cvtag{AB Testing}
\cvtag{KPI Tracking}
\cvtag{Team player}
...
\cvtagline{B2B SaaS Product Manager | Ex-Founder Driving Product Lifecycle and Growth}
...
\begin{itemize}
\item Drove customer acquisition via product-led strategies, getting 5.5K+ monthly leads on a INR 5M budget.
\item Lifted lead conversion 50\% MoM by iterating on user funnels and data-driven product strategies.
...
\begin{itemize}
\item Built automation to boost sales team efficiency, hitting a 45% reply rate and reducing manual effort by 95%.
