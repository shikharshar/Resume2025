...
\cvtagline{Product Builder with a Founder's Mindset | Ex-Founder | IIT Kanpur}
...
\item Boosted lead conversion 50\% MoM by iterating on user-centric funnels based on A/B testing data.
...
\item  Conceptualized a tool to source 10M accounts, guiding the tech team from idea to implementation.
...
\item Retained 250+ key merchants by understanding their needs and redesigning partnership terms during a platform crisis.
