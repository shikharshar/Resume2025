...
\cvtag{Feature Prioritization}
\cvtag{PRD Writing}
\cvtag{Customer Empathy}
...
\cvtagline{Data-Driven Product Manager | IIT Kanpur Alum | Ex-Founder}
...
\begin{itemize}
\item Analyzed campaign data to inform product strategy, improving user acquisition funnels and key metrics.
\item Drove a 50\% MoM conversion lift by analyzing user behavior and iterating on product-led growth features.
...
\begin{itemize}
\item Identified operational bottlenecks; defined and delivered an automation solution reducing manual effort by 95\%.
