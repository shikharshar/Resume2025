...
\begin{itemize}
\item Drove customer acquisition via Meta, analyzing feedback from 5,500+ leads/month to inform product strategy
...
\item Collaborated with 250+ merchants to align on new loan terms, translating business needs into product requirements
